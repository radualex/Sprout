        ...
        <div {...props}>
            <div className={shared.fieldRow}>
                <div className={shared.field}>
                    ...
                    <select id={`${idPrefix}-water`} value={value.waterEveryDays} onChange={(event) => { updateWater(event, value, onChange); }}>
                        {WATER_OPTIONS.map((d) => {
                            return (
                ...
                <div className={shared.field}>
                    ...
                    <select id={`${idPrefix}-fertilize`} value={value.fertilizeEveryDays} onChange={(event) => { updateFertilize(event, value, onChange); }}>
            ...
            <div className={shared.field}>
                ...
                <select id={`${idPrefix}-repot`} value={value.repotEveryMonths} onChange={(event) => { updateRepot(event, value, onChange); }}>
                    <option value={0}>never</option>
                    {REPOT_OPTIONS.map((m) => {
                        return (
